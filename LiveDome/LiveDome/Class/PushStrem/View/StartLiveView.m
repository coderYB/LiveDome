...
- (UIButton*)closeButton{
    ...
    if(!_closeButton){
        ...
        //位置
        _closeButton.frame = CGRectMake(SCREEN_WIDTH - padding * 2, padding, padding, padding);
        [_closeButton setNormalImage:YBNameImage(@"close_preview")];
        _closeButton.exclusiveTouch = YES;
        __weak __typeof__(self) weakSelf = self;
        [_closeButton handlerTouchUpInsideEvent:^(id sender) {
...
- (UIButton*)cameraButton{
    if(!_cameraButton){
        ...
        //位置
        _cameraButton.frame = CGRectMake(SCREEN_WIDTH - padding * 4, padding, padding, padding);
        [_cameraButton setNormalImage:YBNameImage(@"camra_preview")];
        _cameraButton.exclusiveTouch = YES;
        __weak typeof(self) _self = self;
        [_cameraButton handlerTouchUpInsideEvent:^(id sender) {
...
- (UIButton*)beautyButton{
    if(!_beautyButton){
        ...
        [_beautyButton setNormalImage:YBNameImage(@"camra_beauty_close")];
        [_beautyButton setSelectedImage:YBNameImage(@"camra_beauty")];
        _beautyButton.exclusiveTouch = YES;
        __weak typeof(self) _self = self;
        [_beautyButton handlerTouchUpInsideEvent:^(id sender) {
...
- (UIButton*)startLiveButton{
    if(!_startLiveButton){
        ...
        //位置
        _startLiveButton.frame = CGRectMake((SCREEN_WIDTH - 200) * 0.5, SCREEN_HEIGHT - 100, 200, 40);
        ...
        __weak typeof(self) _self = self;
        [_startLiveButton handlerTouchUpInsideEvent:^(id sender) {
